...
from text2sql.framework.modules.transformer_encoder import encoder, pre_process_layer
from text2sql.framework.modules.transformer_encoder import gelu
...
class ErnieModel(object):
    ...
    def __init__(self,
        ...
        :param use_fp16:
        """
        self._emb_size = config.get('emb_size', 768)
        ...
        self._use_task_id = config.get('use_task_id', True)
